...
const TextInput = (props) => {
    ...
    return (
        <>
            <View style={[styles.inputView, { borderColor: props.error ? 'red' : 'black', borderWidth: props.error ? 2 : 1 }]}>

                <BaseTextInput
                    placeholder={props.placeholder}
                    style={[styles.input, {
                        paddingRight: props.secureTextEntry ? ScaleSize.spacing_50 : ScaleSize.spacing_25
                    }]}
                    ...
                    onChangeText={(text) => {
                        ...
                        props.onChangeText(
                            text.trim().length === 0 ? "" : text.replace(regex, "")
                        );
                    }}
                />
...
const styles = StyleSheet.create({
    inputView: {
        borderWidth: ScaleSize.spacing_2,
        width: "100%",
    ...
    rightIcon: {
        position: "absolute",
        right: ScaleSize.spacing_20
    },
    errorText: {
        color: 'red',
        fontSize: TextFontSize.size_14,
        top: -ScaleSize.spacing_15 * 1.2,
        fontFamily: AppFonts.medium,
        marginLeft: ScaleSize.spacing_15
    }
})